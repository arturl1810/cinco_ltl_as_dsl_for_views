...
specified for your \cinco product's model type using a \kw{graphModel}
\code{\{...\}} block\footnote{Actually, the \kw{node} and \kw{edge} blocks are located
\emph{in} this \kw{graphModel} block. See Listing \ref{lst:myMGL}.}.
This time, the \code{@style} annotation points to your \msl{FlowGraph.style},
