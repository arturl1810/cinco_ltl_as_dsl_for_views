...
always be available for download at \href{http://cinco.scce.info}. 
...
1.0'', but the executable build contains several libraries from the
jABC project, for which the following license applies:
