...
in Sec.~\ref{sec:firstLaunch}. It solely consists of \kw{appearance}
\code{\{...\}} blocks, \kw{nodeStyle} \code{\{...\}} blocks, and \kw{edgeStyle}
\code{\{...\}} blocks.


\subsection{Appearance Provider} \label{sec:ap}
