...
(like name or description in the Activity node, cf. lines 32 and 33) can be set
...
each suffixed by an upper/lower bound range in brackets. Line 35 shows a 
...
in curly brackets. Line 25 shows one such set constraint. It expresses that each
