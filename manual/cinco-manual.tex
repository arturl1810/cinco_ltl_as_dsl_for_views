...
\item[git commit id] \gitAbbrevHash (\gitAuthorDate)
...
Those rules are defined within the \mgl{MyModelType.mgl} and the
\msl{MyModelType.style}. The next section will therefore detail on the contents
of those files.
