...
@SIBClass("ge-util-sibs/IsAttributeFile")
public class IsAttributeFile extends AbstractSIB {
	...
	public String execute(LightweightExecutionEnvironment env) {
		return ServiceAdapter.isAttributeFile(env, attributeKey.asFoundation());
	}
