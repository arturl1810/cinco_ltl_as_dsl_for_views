...
@SIBClass("ge-util-sibs/GetNSUri")
public class GetNSUri extends AbstractSIB {

public static final String[] BRANCHES = { Branches.DEFAULT, Branches.ERROR };
	
	public ContextKey object = new ContextKey("object", ContextKey.Scope.LOCAL, true);
	public ContextKey nsUri = new ContextKey("nsUri", ContextKey.Scope.LOCAL, true);
	...
	public String execute(LightweightExecutionEnvironment env) {
		return ServiceAdapter.getNSUri(env,
				object.asFoundation(),
				nsUri.asFoundation());
	}
