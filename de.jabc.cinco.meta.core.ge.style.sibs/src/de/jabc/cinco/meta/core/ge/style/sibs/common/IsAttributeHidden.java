...
@SIBClass("ge-util-sibs/IsAttributeHidden")
public class IsAttributeHidden extends AbstractSIB {
	...
	public String execute(LightweightExecutionEnvironment env) {
		return ServiceAdapter.isAttributeHidden(env, attributeKey.asFoundation());
	}
