...
@SIBClass("ge-util-sibs/IsAttributeReadOnly")
public class IsAttributeReadOnly extends AbstractSIB {
	
		public static final String[] BRANCHES = {Branches.TRUE, Branches.FALSE, Branches.ERROR};
			
		public ContextKey attributeKey = new ContextKey("attribute", Scope.DECLARED, true);
		...
		public String execute(LightweightExecutionEnvironment env) {
			return ServiceAdapter.isAttributeReadOnly(env, attributeKey.asFoundation());
		}
