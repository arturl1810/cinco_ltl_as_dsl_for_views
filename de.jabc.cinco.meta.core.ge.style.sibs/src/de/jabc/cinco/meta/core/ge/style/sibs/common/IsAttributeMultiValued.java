...
@SIBClass("ge-util-sibs/IsAttributeMultiValued")
public class IsAttributeMultiValued extends AbstractSIB {
	...
	public String execute(LightweightExecutionEnvironment env) {
		return ServiceAdapter.isAttributeMultiValued(env, attributeKey.asFoundation());
	}
