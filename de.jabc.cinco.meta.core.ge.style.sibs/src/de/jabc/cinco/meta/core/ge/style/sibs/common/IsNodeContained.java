...
@SIBClass("ge-util-sibs/IsNodeContained")
public class IsNodeContained extends AbstractSIB {

	public static final String[] BRANCHES = {Branches.TRUE, Branches.FALSE, Branches.ERROR};
	
	public ContextKey nodeContainer = new ContextKey("nodeContainer", Scope.LOCAL, true);
	public ContextKey node = new ContextKey("node", Scope.LOCAL, true);
	
	public String execute(LightweightExecutionEnvironment env) {
		return ServiceAdapter.isNodeContained(env, nodeContainer.asFoundation(), node.asFoundation());
	}
