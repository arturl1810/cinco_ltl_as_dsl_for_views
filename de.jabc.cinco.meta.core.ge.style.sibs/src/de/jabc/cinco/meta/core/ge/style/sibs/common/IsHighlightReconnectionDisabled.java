...
@SIBClass("ge-util-sibs/IsHighlightReconnectionDisabled")
public class IsHighlightReconnectionDisabled extends AbstractSIB {
	public static final String[] BRANCHES = {Branches.TRUE, Branches.FALSE, Branches.ERROR};
		...
		public String execute(LightweightExecutionEnvironment env) {
			return ServiceAdapter.isHighlightReconnectionDisabled(env, modelElementKey.asFoundation());
		}
		
		@Override
		public ServiceAdapterDescriptor generate() {
			return new ServiceAdapterDescriptor(ServiceAdapter.class.getName(), 
					"isHighlightReconnectionDisabled",	"modelElementKey");
		}
}
