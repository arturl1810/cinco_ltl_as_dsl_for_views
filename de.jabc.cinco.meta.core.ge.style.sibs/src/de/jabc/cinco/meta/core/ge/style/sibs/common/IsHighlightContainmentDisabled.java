...
@SIBClass("ge-util-sibs/IsHighlightContainmentDisabled")
public class IsHighlightContainmentDisabled extends AbstractSIB {
	public static final String[] BRANCHES = {Branches.TRUE, Branches.FALSE, Branches.ERROR};
		...
		public String execute(LightweightExecutionEnvironment env) {
			return ServiceAdapter.isHighlightContainmentDisabled(env, modelElementKey.asFoundation());
		}
		
		@Override
		public ServiceAdapterDescriptor generate() {
			return new ServiceAdapterDescriptor(ServiceAdapter.class.getName(), 
					"isHighlightContainmentDisabled",	"modelElementKey");
		}
}
