...
public class JBoss7ClasspathURLConverterImpl implements ClasspathURLConverter {
	...
	private URL getRealURL(URL url) throws IOException {
		final URL realURL;
		...
		if (urlString.contains(".jar")) {
			...
			// An example URL:
			// "vfs:/devel/jboss-6.1.0.Final/server/default/deploy/myapp.ear/myapp.war/WEB-INF/lib/tapestry-core-5.2.6.jar/org/apache/tapestry5/corelib/components/"
			...
			// eg.
			// "jar:file:/devel/jboss-6.1.0.Final/server/default/tmp/vfs/automount40a6ed1db5eabeab/myapp.war-43e2c3dfa858f4d2//WEB-INF/lib/tapestry-core-5.2.6.jar!/org/apache/tapestry5/corelib/components/".
