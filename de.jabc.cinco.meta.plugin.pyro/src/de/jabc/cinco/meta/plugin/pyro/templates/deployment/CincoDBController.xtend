			...
			private TypeController typeController;
			   ...
			   public void createGraphModelDBTypes() {
				...
				final DBType edge = this.typeController.createType("Edge");
			       ...
			       System.out.println("[ok]");
			       «FOR Type type : tc.graphModels.map[g|g.types.filter[type|type instanceof UserDefinedType]].flatten»
				       ...
				       DBField typeDbField = this.typeController.addPrimitiveFieldToType(pyroCommand, "type", PropertyType.STRING);
				        ...
				        // Referenced ECOREs
				        «FOR EClassifier eObject : tc.ecores.map[ePack|ePack.EClassifiers].flatten.filter[eObject|eObject instanceof EClass]»
...
'''
	...
	def createAttributeCommmand(GraphicalModelElement element,
	...
	def createAttributes(ModelElement modelElement, ArrayList<Type> enums, GraphModel graphModel) '''
	...
	def createReferenceAttributes(ModelElement modelElement, ArrayList<Type> enums, GraphModel graphModel) '''
		«IF !modelElement.attributes.empty»
			«FOR Attribute attr : modelElement.attributes»
	...
	def createReferenceListAttribute(Attribute attr, ArrayList<Type> enums, String elementName,
	...
	def createListCommandAttribute(Attribute attr, ArrayList<Type> enums,
		String elementName) '''
